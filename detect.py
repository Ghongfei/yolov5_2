...
def detect(save_img=False):
    ...
    model = Model(model_cfg='/home/hongfei/project/yolov5/models/yolov5s.yaml').to(device)
    if os.path.exists(opt.weights):
        ckpt = torch.load('/home/hongfei/project/yolov5/weights/smoke4_best.pt', map_location=device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/smoke4_best.pt', help='model.pt path')
